...
$address = get_setting('CONTACT_ADDRESS', '123 Harbour Street, Sydney NSW 2000, Australia');
$website = get_setting('WEBSITE_URL', 'ict726.kpmquockhanh.site');
$working_hours_weekday = get_setting('WORKING_HOURS_WEEKDAY', 'Mon-Fri 9:00AM – 5:00PM');
$working_hours_weekend = get_setting('WORKING_HOURS_WEEKEND', 'Sat-Sun 10:00AM – 6:00PM');
?>
...
<section class="hero contact">
    <div class="container">
        <div>
            <h1>Your Handy Partner Is Just a Call Away</h1>
            <p class="clamped-text">Looking for a dependable handyman? We're here to tackle your to-do list quickly and
                professionally. Get in touch now!
            </p>
            <div class="buttons">
                ...
                <button class="btn btn-secondary">
                    ...
                    <span class="text">Call <?php echo htmlspecialchars($phone); ?></span>
                </button>
            </div>
        </div>
    </div>
...
<section class="contact-us">
    <div class="container">
        <h2 class="text-center mb-xl">Reach Out to Our Team</h2>
        <div class="dbox-wrapper flex gap-2 mb-xl">
            <div class="dbox">
                <div class="icon">
                    <span class="fa fa-phone"></span>
                </div>
                <div class="text">
                    <p><a href="tel:<?php echo preg_replace('/\s+/', '', $phone); ?>"><?php echo htmlspecialchars($phone); ?></a></p>
                </div>
            </div>
            <div class="dbox">
                <div class="icon">
            ...
            <div class="dbox">
                ...
                <div class="text">
                    <p><a href="https://<?php echo htmlspecialchars($website); ?>" target="_blank"><?php echo htmlspecialchars($website); ?></a></p>
                </div>
            </div>
        </div>
    </div>
    <div class="container guarantee flex gap-2">
        <img src="/assets/images/guarantee.png" alt="guarantee image">
        <div class="content">
            ...
            <p><?php echo htmlspecialchars($working_hours_weekday); ?></p>
            <p><?php echo htmlspecialchars($working_hours_weekend); ?></p>
        </div>
    </div>

    <div id="form-wrapper">
        <div class="container">
            <h2 class="text-center mb-xl white">Talk to Us</h2>
        </div>
        <div class="container mt mb">
            <div id="formStatus"></div>
        </div>
        <div class="container form-content flex justify-content-center align-items-center">
            <form id="contact-form">
                ...
                <div class="form-group position-relative">
                    ...
                    <input type="text" id="formName" class="form-control form-control-lg thick" name="formName" placeholder="Name">
                    <div id="messageName" class="error-message"></div>
                </div>
                ...
                <div class="form-group position-relative">
                    ...
                    <input type="email" id="formEmail" class="form-control form-control-lg thick" name="formEmail" placeholder="E-mail">
                    <div id="messageEmail" class="error-message"></div>
                </div>

                <!-- Message -->
                <div class="form-group message">
                    <textarea id="formMessage" class="form-control form-control-lg" rows="7" name="formMessage" placeholder="Message"></textarea>
                    <div id="messageMessage" class="error-message"></div>
                </div>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 790 563" fill="none" id="animated-envelop">
                <g id="Image">
                    <g id="g14">
                        <g id="g16">
                            <g id="g22">
                            ...
                            <g id="g158">
                                <path id="path160" d="M194.298 545.299C131.158 507.676 73.43 460.749 23.4922 406.451"
                                      stroke="#55CDE2" stroke-width="2.541" stroke-miterlimit="10" stroke-dasharray="7.62 7.62" />
                            </g>
                            <g id="g162">
                                <path id="path164"
